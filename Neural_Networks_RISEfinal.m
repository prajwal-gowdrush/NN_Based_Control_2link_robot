...
[qd_ini,qdDot_ini,~]  = des_trajectory(0);

e_initial=qd_ini-q_ini;
eDot_initial= qdDot_ini-qDot_ini;

e2_initial = e_initial + alpha*eDot_initial;
mu_term2_initial = (ks+1)*alpha2*e2_initial + beta1*sign(e2_initial);

%% Run Simulation
[t,~,states,u,qd,f_hat,f,w_hat,v_hat] = sim('Model_Composite_2Link_NN_RISEfinal');
